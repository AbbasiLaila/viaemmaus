...
<section class="content">
  <div class="row">
    <div class="col-md-12">
      <form role="form"  action="<?php echo base_url('admin/tours/add') ?>" method="post" enctype="multipart/form-data">
        ...
        <div class="col-md-12"> 
          ...
          <div class="box box-primary"> 
            ...
            <div class="box-body">
              ...
              <div class="form-group">
                <label for="image">Tour Thumbnail</label>
      ...
      <div class="clear"></div>
        ...
        <div class="text-center">
          ...
          <a href="<?=base_url('tours')?>" class="btn btn-info">Back</a>
        </div>
      </form>
    </div>
  </div>
