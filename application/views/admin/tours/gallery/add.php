...
<section class="content">
  <div class="row">
    <div class="col-md-12">
      <form role="form"  action="<?php echo base_url('admin/tour/gallery/add/'.$tour_id) ?>" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group">
      ...
      <div class="loader"><img src="<?=base_url('assets/adminPanel/images/loader.gif')?>" alt=""></div>        
        <div class="text-center">
          ...
          <a href="<?php echo base_url('admin/tour/'.$tour_id)?>" class="btn btn-info">Back</a> </div>
        </div>
      </form>
    </div>
  </div>
