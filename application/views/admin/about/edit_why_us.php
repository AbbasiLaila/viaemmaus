...
<section class="content">
  <?=@$this->session->flashdata('dataEdited')?>
  <div class="row">
    <div class="col-md-12">
      <form role="form"  action="<?php echo base_url('admin/why_us/edit/'.$data->id) ?>" method="post" enctype="multipart/form-data">
        ...
        <div class="col-md-6">
              ...
              <div class="form-group">
                ...
                <img class="minimge" src="<?= base_url('uploads/'.$data->image)?>" /> </div>
            </div>
            <!-- /.box-body --> 
        <div class="clear"></div>
        ...
        <div class="text-center">
          ...
          <a href="<?php echo base_url('admin/about/why_us')?>" class="btn btn-info">Back</a> </div>
      </form>
    </div>
  </div>
</section>
