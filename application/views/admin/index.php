         ...
         <ul class="timeline">
            <li>
               ...
               <div class="timeline-item">
                  <h3 class="timeline-header no-border">Welcome to <a href="<?php echo base_url('admin')?>" target="_blank">Via Ammaus website CMS Template</a>,  <?= $this->ion_auth->user()->row()->first_name.' '.$this->ion_auth->user()->row()->last_name?>.</h3>
                  <div class="timeline-body">
                     Through CMS, Admin will be able to manage and take control of <a href="<?php echo base_url('')?>" target="_blank">Via Ammaus</a> website's content without having to touch the code.
                  </div>
