<div class="page-container">
	<div class="inner-page">
		...
		<a href="<?=base_url('/front/service')?>" class="service">
			<div class="service-inner">
				<img src="<?=base_url('assets/images/guide.jpg')?>"/>
				
				<div class="service-information">
					<h1>Guides </h1>
	                <p>fluent in the language of your choice, certified by the respective ministry of tourism..</p>
				</div>
			</div>
		</a>
		...
		<a href="<?=base_url('/front/service')?>" class="service">
			<div class="service-inner">
				<img src="<?=base_url('assets/images/res.jpg')?>"/>
		...
		<a href="<?=base_url('/front/service')?>" class="service">
			<div class="service-inner">
				<img src="<?=base_url('assets/images/car.jpg')?>"/>
				
				<div class="service-information">
					<h1>Modern Transportation</h1>
	                <p>fluent in the language of your choice, certified by the respective ministry of tourism..</p>
				</div>
			</div>
		</a>
