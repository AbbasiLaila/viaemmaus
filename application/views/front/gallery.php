<div class="page-container">
	<div class="inner-page">
		<div class="inner-page-header" style="background:url('<?=base_url('assets/images/g.jpg')?>'); background-size: cover;background-position: center center;">
		...
		<a href="<?=base_url('/front/album')?>" class="service">
			<div class="service-inner">
				<img src="<?=base_url('assets/images/g1.jpg')?>"/>
				
				<div class="service-information">
					<h1>Span Tour <span class="date">- 10 March 2015 -</span></h1>
		...
		<a href="<?=base_url('/front/album')?>" class="service">
			<div class="service-inner">
				...
				<div class="service-information">
					<h1>Holy Land Tour <span class="date">- 10 March 2015 -</span></h1>
	                <p>fluent in the language of your choice, certified by the respective ministry of tourism..</p>
				</div>
			</div>
		</a>
		...
		<a href="<?=base_url('/front/album')?>" class="service">
			<div class="service-inner">
				...
				<div class="service-information">
					<h1>Tour 4 <span class="date">- 10 March 2015 -</span></h1>
	                <p>fluent in the language of your choice, certified by the respective ministry of tourism..</p>
				</div>
			</div>
		</a>
		...
		<a href="<?=base_url('/front/album')?>" class="service">
			<div class="service-inner">
				...
				<div class="service-information">
					<h1>Tour 3 <span class="date">- 10 March 2015 -</span></h1>
	                <p>fluent in the language of your choice, certified by the respective ministry of tourism..</p>
				</div>
			</div>
		</a>
