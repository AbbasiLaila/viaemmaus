...
class Auth extends CI_Controller {
...

	{
...

		{
			...
			$this->_render_page('admin/include/head', $this->data);

			$this->_render_page('admin/index', $this->data);

			$this->_render_page('admin/include/footer');
...
$this->_render_page('admin/include/head',$this->data);
		...
		$this->_render_page('admin/include/footer',$this->data);		}
 ...
 if ($this->ion_auth->in_group('super')){
...

        {
            ...
            $this->session->set_flashdata('userAdded', $this->ion_auth->messages());
